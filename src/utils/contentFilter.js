// Client-side content filter (mirrors server/contentFilter.js)
...
export function censorText(input, options = {}) {
  const banned = (options.bannedWords || [
    ...
    'spic', 'wetback', 'beaner', 'greaser', 'pepper belly',
    // Racial slurs - Jewish
    ...
    // Racial slurs - White
    'cracker', 'honky', 'whitey', 'gringo', 'haole',
  ...
  const exceptions = (options.exceptions || [
    ...
    'assess', 'assignment', 'assumption', 'bass', 'mass', 'pass', 'assing'
  ]).map(e => e.toLowerCase());
